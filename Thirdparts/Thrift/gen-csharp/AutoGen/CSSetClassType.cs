...
namespace AutoGen
{
  ...
  [Serializable]
  #endif
  public partial class CSSetClassType : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("CSSetClassType");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("CSSetClassType(");
      bool __first = true;
      if (__isset.classType) {
