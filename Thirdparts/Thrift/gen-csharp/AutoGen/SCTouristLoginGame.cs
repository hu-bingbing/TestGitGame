...
namespace AutoGen
{
  ...
  [Serializable]
  #endif
  public partial class SCTouristLoginGame : TBase
  {
    private int _result;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("SCTouristLoginGame");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("SCTouristLoginGame(");
      bool __first = true;
      if (__isset.result) {
