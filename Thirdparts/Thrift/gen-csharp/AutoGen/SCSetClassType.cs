...
namespace AutoGen
{
  ...
  [Serializable]
  #endif
  public partial class SCSetClassType : TBase
  {
    private int _result;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("SCSetClassType");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("SCSetClassType(");
      bool __first = true;
      if (__isset.result) {
