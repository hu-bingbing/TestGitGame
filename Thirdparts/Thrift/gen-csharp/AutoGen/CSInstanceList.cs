...
namespace AutoGen
{
  ...
  [Serializable]
  #endif
  public partial class CSInstanceList : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("CSInstanceList");
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("CSInstanceList(");
      bool __first = true;
      if (__isset.startIndex) {
