...
public abstract class FingerGesture
{
    public delegate void EventHandler( FingerGesture gesture );
    ...
    /// </summary>
    public static implicit operator bool( FingerGesture gesture )
    {
        return gesture != null;
    }
...
/// </summary>
public abstract class GestureRecognizerTS<T> : GestureRecognizer where T : FingerGesture, new()
{
    List<T> gestures;
    ...
    protected virtual void OnStateChanged( FingerGesture gesture )
    {
